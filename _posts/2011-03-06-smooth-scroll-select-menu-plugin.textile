...
<p>
	<select name="car_makes[1]" class="jq_hoverToScroll" id="car_select">
...
<p>
	<select name="car_makes[2]" class="jq_changeScrollSpeed" id="car_select">
	  <option value="acura">Acura</option>
	  <option value="alfaromeo">Alfa Romeo</option>
	  <option value="audi">Audi</option>
	  <option value="bmw">BMW</option>
...
<div>
	<select name="car_makes[3]" class="jq_clickToScroll" id="car_select2">
	  <option value="acura">Acura</option>
	  <option value="alfaromeo">Alfa Romeo</option>
	  <option value="audi">Audi</option>
	  <option value="bmw">BMW</option>
...
<div>
	<select name="car_makes[4]" class="jq_afterOpenExample" id="car_select2">
	  <option value="acura">Acura</option>
	  <option value="alfaromeo">Alfa Romeo</option>
	  <option value="audi">Audi</option>
	  <option value="bmw">BMW</option>
...
<div>
	<select name="car_makes[5]" class="jq_afterSelectExample" id="car_select2">
	  <option value="acura">Acura</option>
	  <option value="alfaromeo">Alfa Romeo</option>
	  <option value="audi">Audi</option>
	  <option value="bmw">BMW</option>
